...
public class ResearcherTest {
	...
	@Test
	public void hasPaperToReviewInConferenceTrueTest() {
		assertTrue(researchers.get(6).
				hasPaperToReviewInConference(conferences.get(1)));
		assertTrue(researchers.get(7).
				hasPaperToReviewInConference(conferences.get(0)));
		assertTrue(researchers.get(2).
				hasPaperToReviewInConference(conferences.get(1)));
	}
	
	@Test
	public void hasPaperToReviewInConferenceFalseTest() {
		assertFalse(researchers.get(8).
				hasPaperToReviewInConference(conferences.get(1)));
		assertFalse(researchers.get(5).
				hasPaperToReviewInConference(conferences.get(0)));
		assertFalse(researchers.get(7).
				hasPaperToReviewInConference(conferences.get(2)));
	}
	
	@Test
	public void isAbleToReviewTrueTest() {
		assertTrue(researchers.get(1).
				isAbleToReview(articles.get(0), conferences.get(0)));
		assertTrue(researchers.get(5).
				isAbleToReview(articles.get(7), conferences.get(2)));
	...
	public void isAbleToReviewFalseTestAlreadyAllocated() {
		assertFalse(researchers.get(5).
				isAbleToReview(articles.get(4), conferences.get(1))); //já avalia o artigo
		assertFalse(researchers.get(1).
				isAbleToReview(articles.get(4), conferences.get(1))); // já avalia na conf.
	}

	@Test
	public void isAbleToReviewFalseTestDifferentInterest() {
		assertFalse(researchers.get(2).
				isAbleToReview(articles.get(1), conferences.get(1)));
		assertFalse(researchers.get(4).
				isAbleToReview(articles.get(3), conferences.get(1)));
	}
	
	@Test
	public void isAbleToReviewFalseTestSameAffiliation() {
		assertFalse(researchers.get(0).
				isAbleToReview(articles.get(0), conferences.get(0))); //mesmo autor
		assertFalse(researchers.get(2).
				isAbleToReview(articles.get(0), conferences.get(0))); //mesma universidade
	}
}
